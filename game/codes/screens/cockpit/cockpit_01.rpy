screen cockpit_01: #hover rokok
    ...
    imagebutton:
        ...
        xpos 0.5
        ypos 0.28
        action Play("sound", "audio/Paper_sfx.wav"), Jump("note_1")
    imagebutton:
        idle "radio_idle.png"
        hover "radio.png"
        xanchor -67
    ...
    imagebutton:
        ...
        xpos 0.5
        ypos 0.28
        action [SetVariable("player_checked_fatimah_photo", True), Play("sound", "audio/Pick Up Item_sfx.mp3"), Jump("fatimah_image")]